            ...
            <form class="row g-3 mt-1" action = "{{route('saveAuto')}}" method="POST">
              ...
              <div class="col-6">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" value="{{old('txtAno')}}" name="txtAno" placeholder="Ingresa el año del auto"> 
                </div>
              ...
              <div class="col-6">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" value="{{old('txtVersion')}}" name="txtVersion" placeholder="Ingresa la versión del auto">
                </div>
